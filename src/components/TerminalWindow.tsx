...
export function TerminalWindow({ title, children, className = "", actions }: TerminalWindowProps) {
  return (
    <section className={`terminal-window overflow-hidden rounded-2xl border border-terminal/40 bg-panel/90 shadow-terminal backdrop-blur-md transition duration-300 ${className}`}>

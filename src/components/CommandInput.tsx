  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-2 border-t border-terminal/25 bg-void/90 p-2.5 sm:p-3">
      ...
      <input
        ...
        className="min-w-0 flex-1 rounded-xl border border-terminal/30 bg-black/65 px-3 py-2 text-sm text-terminal outline-none transition duration-200 placeholder:text-emerald-200/35 focus:border-cyanwire focus:shadow-focusRing"
        autoComplete="off"
      />
